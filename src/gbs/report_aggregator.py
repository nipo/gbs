...
Merges multiple standalone HTML report files into a single self-contained
HTML document with a tabbed interface. Each source page is embedded in an
<iframe srcdoc="..."> to preserve its original styles without leaking.
